...
//          button(onClick := (_ => openEditorInNewWindow()))("Open Editor in New Window")
//        ),
...
//            dangerouslySetInnerHTML := new js.Object {
//              val __html = state
//            }
//          ),
...
//    setState(e.target.asInstanceOf[dom.html.Div].innerHTML)
//  }
//
//  def openEditorInNewWindow(): Unit = {
//    val editorWindow = dom.window.open("", "_blank", "width=800,height=600")
...
//         |    <script src="target/scala-2.13/texteditor_react_scala-fastopt/main.js"></script>
//         |</head>
//         |<body>
//         |<div id="root"></div>
//         |<script>
